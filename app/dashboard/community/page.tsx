          ...
          {[
            ...
            <div key={idx} className="card-wellness hover:shadow-lg hover:-translate-y-0.5 transition-all">
              ...
              <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                <Button type="button" variant="ghost" size="sm" className="h-auto min-h-0 px-2" aria-label={`Like post: ${post.title}`}><Heart className="w-4 h-4" />{post.likes}</Button>
                <Button type="button" variant="ghost" size="sm" className="h-auto min-h-0 px-2" aria-label={`Reply to post: ${post.title}`}><MessageCircle className="w-4 h-4" />{post.replies}</Button>
                <Button type="button" variant="ghost" size="sm" className="h-auto min-h-0 px-2" aria-label={`Share post: ${post.title}`}><Share2 className="w-4 h-4" />Share</Button>
              </div>
            </div>
          ))}
        </div>
