        ...
        <div className="card-wellness">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm">Save Changes</Button>
        ...
        <div className="space-y-6">
          <div className="card-wellness">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <Button className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm">Update Password</Button>
                <Button variant="outline">Cancel</Button>
              </div>
            </div>
          </div>
