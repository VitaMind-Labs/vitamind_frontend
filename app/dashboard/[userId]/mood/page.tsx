          ...
          <div className="mood-tracker mb-6">
            {[
              ...
              <button
                ...
                className={`mood-button hover:scale-105 ${selectedMood === mood.value ? 'selected' : ''}`}
              >
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {['Sleep', 'Work', 'Relationships', 'Health', 'Weather', 'Exercise', 'Diet', 'Stress'].map((factor) => (
                <button key={factor} className="px-3 py-2 rounded-lg border border-border hover:border-primary hover:bg-primary/5 hover:shadow-sm transition-all text-sm font-medium text-foreground">
                  {factor}
                </button>
              ))}
            </div>
