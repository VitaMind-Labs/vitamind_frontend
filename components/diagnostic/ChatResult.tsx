      ...
      <div className="bg-white/80 backdrop-blur-2xl border border-white/60 rounded-[28px] w-full shadow-[0_8px_40px_rgba(0,0,0,0.06)] overflow-hidden">
              ...
              <div className="space-y-2.5 mt-auto">
                {isSoundEnabled && (
                  <button
                    ...
                    className="inline-flex w-full items-center justify-center gap-2 px-4 py-3 rounded-xl border border-gray-200 bg-white text-gray-600 text-sm font-medium shadow-sm hover:bg-primary hover:text-white hover:border-primary transition-all duration-300"
                  >
                ...
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-primary to-primary/90 text-white text-sm font-semibold shadow-md shadow-primary/15 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300"
                >
        ...
        <div className="px-6 sm:px-8 py-4 border-t border-gray-100 bg-gray-50/50 flex flex-wrap items-center justify-between gap-3">
          <button
            type="button"
            onClick={onRestart}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-primary to-primary/90 text-white text-sm font-semibold shadow-md shadow-primary/15 hover:shadow-lg transition-all duration-300 active:scale-95"
          >
          ...
          <Link
            href={signupHref}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white border border-gray-200 text-gray-600 text-sm font-medium hover:border-primary/20 hover:bg-primary/5 hover:text-primary transition-all duration-300"
          >
